  ...
  public function run(): void
    {
        $settings = [
            ...
            // --- PENGATURAN HALAMAN KONTAK (BARU) ---
            ['key' => 'contact_header_title', 'value' => 'Hubungi Kami'],
            ['key' => 'contact_header_subtitle', 'value' => 'Ada pertanyaan? Kami siap membantu Anda'],
            ['key' => 'contact_phone_2', 'value' => '(021) 1234-5678'], // Nomor telepon kedua
            ['key' => 'contact_email_2', 'value' => 'order@3saudara.com'], // Email kedua
        ...
        foreach ($settings as $setting) {
            Setting::updateOrCreate(
                ...
                ['value' => $setting['value']]  // Update atau Buat dengan value ini
            );
        }
