                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center border-0 shadow-sm h-100 py-4">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Jl. Pantai Indah No. 123<br>Jakarta Utara 14450</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center border-0 shadow-sm h-100 py-4">
                        <div class="card-body">
                            ...
                            <a href="tel:+6281234567890" class="text-muted text-decoration-none d-block small">+62 812-3456-7890</a>
                            <a href="tel:+622112345678" class="text-muted text-decoration-none d-block small">(021) 1234-5678</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center border-0 shadow-sm h-100 py-4">
                        <div class="card-body">
                            ...
                            <a href="mailto:info@3saudara.com" class="text-muted text-decoration-none d-block small">info@3saudara.com</a>
                            <a href="mailto:order@3saudara.com" class="text-muted text-decoration-none d-block small">order@3saudara.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center border-0 shadow-sm h-100 py-4">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Senin - Sabtu: 08:00 - 20:00<br><span class="text-danger">Minggu Tutup</span></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <form action="https://wa.me/6281234567890" method="GET" target="_blank" x-data="{ name: '', email: '', phone: '', subject: '', message: '' }">
                        <div class="row g-3">
                            <div class="col-md-12">
...
${message}`">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="ratio ratio-16x9 rounded-3 shadow-sm mb-4" style="height: 250px;">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.666667!2d106.7777777!3d-6.1666666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMTAnMDAuMCJTIDEwNsKwNDYnNDAuMCJF!5e0!3m2!1sen!2sid!4v1234567890" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm bg-light p-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-3">
                                <a href="#" class="btn btn-primary rounded-circle" style="width: 44px; height: 44px;"><i class="bi bi-facebook fs-5"></i></a>
                                <a href="#" class="btn text-white rounded-circle" style="width: 44px; height: 44px; background: #d6249f; background: radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%);"><i class="bi bi-instagram fs-5"></i></a>
                                <a href="#" class="btn text-white rounded-circle" style="width: 44px; height: 44px; background-color: #25D366;"><i class="bi bi-whatsapp fs-5"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
