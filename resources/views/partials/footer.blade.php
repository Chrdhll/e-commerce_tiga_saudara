        ...
        <div class="row gy-4 mb-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled d-flex flex-column" style="gap: 0.5rem;">
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Beranda</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Produk</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Kategori</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Tentang Kami</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled d-flex flex-column" style="gap: 0.5rem;">
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Ikan Segar</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Udang</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Kepiting</a></li>
                    <li><a href="#" class="text-white-50 link-light text-decoration-none">Lobster</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled d-flex flex-column" style="gap: 0.75rem;">
                    <li class="d-flex align-items-start">
                        ...
                        <span>Jl. Pantai Indah No. 123, Jakarta</span>
                    </li>
